...
})({"2bbJg":[function(require,module,exports) {
require("2d5e95471790ead3")(require("d8552966d55cb54").getBundleURL("l3Haa") + "TreeMap.css" + "?" + Date.now());

},{"2d5e95471790ead3":"5SiL5","d8552966d55cb54":"ftuBb"}],"5SiL5":[function(require,module,exports) {
"use strict";
...
},{}],"3R31p":[function(require,module,exports) {
require("30747437e0c68923")(require("9a9a949eb8b65572").getBundleURL("l3Haa") + "../commons/palette.css" + "?" + Date.now());

},{"30747437e0c68923":"5SiL5","9a9a949eb8b65572":"ftuBb"}],"8AvRg":[function(require,module,exports) {
require("69cbea94af9fc232")(require("a2e7dd7607cf8ac").getBundleURL("l3Haa") + "../commons/tooltip.css" + "?" + Date.now());

},{"69cbea94af9fc232":"5SiL5","a2e7dd7607cf8ac":"ftuBb"}],"8225m":[function(require,module,exports) {
...
},{}],"7v1tY":[function(require,module,exports) {
...
class TreeMap extends (0, _baseDefault.default) {
    ...
    setupElements() {
        this.svg = (0, _d3Selection.select)(this.container).classed("gv-container", true).append("svg").attr("class", "gv-plot").on("pointerleave", this.onPointerLeave.bind(this));
    ...
    build() {
      ...
      so in this case we have to add it*/ if (root.children.length === 1) this.svg.append("text").attr("id", "first-breadcrumb").attr("class", "treemap-breadcrumb").attr("y", "21px").attr("x", "0").style("text-anchor", "start").style("font-weight", "bold").text(this.getGroupItems[0]);
            ...
            node.append("rect").attr("id", (d)=>d.leafUid = `tm-leaf-${this.seed()}`).attr("fill", (d)=>{
        ...
        const zoomin = (d)=>{
            ...
            this.svg.transition().duration(TRANSITION_DURATION).call((t)=>group0.transition(t).remove().call(position, d.parent)).call((t)=>group1.transition(t).attrTween("opacity", ()=>(0, _d3Interpolate.interpolate)(0, 1)).call(position, d));
        };
        ...
        const zoomout = (d)=>{
            ...
            this.svg.transition().duration(TRANSITION_DURATION).call((t)=>group0.transition(t).remove().attrTween("opacity", ()=>(0, _d3Interpolate.interpolate)(1, 0)).call(position, d)).call((t)=>group1.transition(t).call(position, d.parent));
        };
        // if there's no value to sum, just count the node
        const valueFn = this.valueProp ? (0, _d3Hierarchy.hierarchy)(this.data).sum((d)=>d[this.valueProp]).sort((a, b)=>b.value - a.value) : (0, _d3Hierarchy.hierarchy)(this.data).count().sort((a, b)=>b.value - a.value);
        // tile function required to place the "groupData" (see parse func.)
        const root = (0, _d3Hierarchy.treemap)().tile(this.tile.bind(this))(valueFn);
        this.setScales();
    ...
    setScales() {
        this.scaleX = (0, _d3Scale.scaleLinear)().rangeRound([
            0,
            this.width
        ]);
        this.scaleY = (0, _d3Scale.scaleLinear)().rangeRound([
            0,
            this.height
        ]);
    }
    setColorScale() {
        this.scaleColor = (0, _d3Scale.scaleOrdinal)().range(this.PALETTE);
    }
    ...
    tile(node, x0, y0, x1, y1) {
        (0, _d3Hierarchy.treemapBinary)(node, 0, 0, this.width, this.height);
    ...
    parse(data) {
        const reduce = this.valueProp ? (v)=>(0, _d3Array.sum)(v, (d)=>d[this.valueProp]) : ()=>{};
        ...
        const rollupData = (0, _d3Array.rollup)(data, reduce, ...groupBys);
        // still needing which items belongs to what category, so appends also the group function
        const groupData = (0, _d3Array.group)(data, ...groupBys);
...
},{"../commons/base":"i3PMv","d3-selection":"gn9gd","d3-hierarchy":"ffs4h","d3-scale":"UQ8g3","d3-interpolate":"6jJyi","d3-array":"1yX2W","d3-transition":"4lorl","./TreeMap.css":"4acqm","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"i3PMv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _d3Selection = require("d3-selection");
...
},{"d3-selection":"gn9gd","d3-time-format":"4FtNS","../../package.json":"dIKiH","./palette.css":"6FUN1","./tooltip.css":"crpqY","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"gn9gd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"6FUN1":[function(require,module,exports) {
module.exports = require("939a85e1a5c18891").getBundleURL("l3Haa") + "../commons/palette.css" + "?" + Date.now();

},{"939a85e1a5c18891":"ftuBb"}],"crpqY":[function(require,module,exports) {
module.exports = require("5c57617cfecbca62").getBundleURL("l3Haa") + "../commons/tooltip.css" + "?" + Date.now();

},{"5c57617cfecbca62":"ftuBb"}],"ffs4h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./transition/index.js":"h2Srb","./transition/schedule.js":"de74c","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"4acqm":[function(require,module,exports) {
module.exports = require("1e10153655b71bcc").getBundleURL("l3Haa") + "TreeMap.css" + "?" + Date.now();

},{"1e10153655b71bcc":"ftuBb"}]},["2bbJg","3R31p","8AvRg","8225m","7v1tY"], "7v1tY", "parcelRequire3004")
