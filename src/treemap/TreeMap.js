...
})({"65hNg":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f54b5c0f1c2d8ede";
...
},{}],"3mc6W":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('l3Haa') + "../barchart_split/BarChartSplit.css" + "?" + Date.now());
...
},{}],"9jxbx":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('l3Haa') + "../barchart_stacked/BarChartStacked.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"a03gV":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('l3Haa') + "../beeswarm/BeeSwarm.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"3R31p":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('l3Haa') + "../commons/palette.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"8AvRg":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('l3Haa') + "../commons/tooltip.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"7uVrb":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('l3Haa') + "../gantt/Gantt.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"2bbJg":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('l3Haa') + "TreeMap.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"3ENVa":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('l3Haa') + "../../examples/src/index.b8531977.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"7v1tY":[function(require,module,exports) {
...
class TreeMap extends _baseDefault.default {
    ...
    setupElements() {
        this.svg = _d3Selection.select(this.container).classed("gv-container", true).append("svg").attr("class", "gv-plot").on("pointerleave", this.onPointerLeave.bind(this));
    ...
    build() {
        ...
        const render = (group, root)=>{
            ...
            node.on("touchmove", (e)=>e.preventDefault()
            ).on("pointerenter", (e, d)=>d === root && this.onPointerLeave(e, d)
            ).on("pointermove", this.onPointerMove.bind(this)).attr("cursor", "pointer").on("click", (e, d)=>d === root ? zoomout(root) : d.height === 0 ? this.onLeafClick(e, d) : zoomin(d)
            );
        ...
        const position = (group, root)=>{
            ...
            ).selectChild().call((e)=>e.style("opacity", 0).transition().duration(TRANSITION_DURATION).style("opacity", 1)
            ).on("end", (d, ix, nodes)=>{
        ...
        const zoomin = (d)=>{
            const group0 = group1.attr("pointer-events", "none");
            const group11 = group1 = this.svg.append("g").call(render, d);
            this.scaleX.domain([
                d.x0,
                d.x1
            ]);
            ...
            this.svg.transition().duration(TRANSITION_DURATION).call((t)=>group0.transition(t).remove().call(position, d.parent)
            ).call((t)=>group11.transition(t).attrTween("opacity", ()=>_d3Interpolate.interpolate(0, 1)
                ).call(position, d)
            );
        };
        ...
        const zoomout = (d)=>{
            const group0 = group1.attr("pointer-events", "none");
            const group12 = group1 = this.svg.insert("g", "*").call(render, d.parent);
            this.scaleX.domain([
                d.parent.x0,
                d.parent.x1
            ]);
            ...
            this.svg.transition().duration(TRANSITION_DURATION).call((t)=>group0.transition(t).remove().attrTween("opacity", ()=>_d3Interpolate.interpolate(1, 0)
                ).call(position, d)
            ).call((t)=>group12.transition(t).call(position, d.parent)
            );
        };
        ...
        const root1 = _d3Hierarchy.treemap().tile(this.tile.bind(this))(valueFn);
        this.setScales();
        // clean the elements before render
        this.svg.selectAll("*").remove();
        let group1 = this.svg.append("g").call(render, root1);
    }
    async setData(data) {
        this.rawData = data;
    ...
    onPointerMove(event, d) {
        ...
        if (!this.cursorInsideTooltip && !isBreadcrumb && d.parent) {
            ...
            tooltip.style("top", `${y}px`).style("left", `${x}px`).style("pointer-events", "auto").call((t)=>t.transition().duration(400).style("opacity", 1)
    ...
    nodePath(d1) {
        return d1.ancestors().reverse().map((d)=>d.data[this.idProp]
        );
    }
    defaultBreadcrumb(d) {
...
},{"../commons/base":"i3PMv","d3-selection":"gn9gd","d3-hierarchy":"ffs4h","d3-scale":"UQ8g3","d3-interpolate":"6jJyi","d3-array":"1yX2W","d3-transition":"4lorl","./TreeMap.css":"a5E08","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"i3PMv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _d3Selection = require("d3-selection");
...
},{}],"izHCq":[function() {},{}],"3Cfo6":[function() {},{}],"ffs4h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./cluster.js":false,"./hierarchy/index.js":"dhu0L","./pack/index.js":false,"./pack/siblings.js":false,"./pack/enclose.js":false,"./partition.js":false,"./stratify.js":false,"./tree.js":false,"./treemap/index.js":"ctDPr","./treemap/binary.js":"hUJ2M","./treemap/dice.js":"k7Rgs","./treemap/slice.js":"iVdqy","./treemap/sliceDice.js":false,"./treemap/squarify.js":"k9MP1","./treemap/resquarify.js":false,"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"dhu0L":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"6syzK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"gyWQ5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function(callback, that) {
    var node = this, nodes = [
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"9cRTr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function(callback, that) {
    var node = this, nodes = [
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"jqiE6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function(callback, that) {
    let index = -1;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"1vi3r":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function(value) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"f2orR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function(compare) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"5UvUd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"61qy3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function() {
    var node = this, nodes = [
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"gUlPE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function() {
    return Array.from(this);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"czIpN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function() {
    var leaves = [];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"65v1r":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function() {
    var root = this, links = [];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"cBZOh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function*() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"ctDPr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./round.js":"8pZ7K","./squarify.js":"k9MP1","../accessors.js":"6pg0v","../constant.js":"lEKIl","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"8pZ7K":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function(node) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"k9MP1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./dice.js":"k7Rgs","./slice.js":"iVdqy","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"k7Rgs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"iVdqy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function(parent, x0, y0, x1, y1) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"6pg0v":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"lEKIl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"hUJ2M":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"UQ8g3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./transition/index.js":"h2Srb","./transition/schedule.js":"de74c","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"a5E08":[function() {},{}]},["65hNg","3mc6W","9jxbx","a03gV","3R31p","8AvRg","7uVrb","2bbJg","3ENVa","7v1tY"], "7v1tY", "parcelRequire3004")
