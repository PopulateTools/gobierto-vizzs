...
})({"8FW0f":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "246b90f613c90599";
...
},{}],"etPzi":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('37Ryj') + "BarChartSplit.css" + "?" + Date.now());
...
},{}],"gNjPM":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('37Ryj') + "../barchart_stacked/BarChartStacked.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"cWaQS":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('37Ryj') + "../beeswarm/BeeSwarm.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"iw7Mm":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('37Ryj') + "../commons/palette.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"73APt":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('37Ryj') + "../commons/tooltip.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"iregX":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('37Ryj') + "../gantt/Gantt.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"hyiOl":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('37Ryj') + "../treemap/TreeMap.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"4Zrfq":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('37Ryj') + "../../examples/src/index.b8531977.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"abVTo":[function(require,module,exports) {
...
var _barChartSplitCss = require("./BarChartSplit.css");
class BarChartSplit extends _baseDefault.default {
    ...
    build() {
        ...
        gColumn.selectAll(".label").data((d)=>d.values
            ...
            if (xValue < xMax) _d3Selection.select(element[i]).attr('x', xValue + 10).attr("fill", "#000");
...
exports.default = BarChartSplit;

},{"../commons/base":"i3PMv","d3-selection":"gn9gd","d3-array":"1yX2W","d3-collection":"lgnY5","d3-time":"1UOEe","d3-time-format":"4FtNS","d3-scale":"UQ8g3","d3-axis":"2g6gM","d3-transition":"4lorl","./BarChartSplit.css":"kVuU2","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"i3PMv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _d3Selection = require("d3-selection");
var _d3TimeFormat = require("d3-time-format");
...
},{"./transition/index.js":"h2Srb","./transition/schedule.js":"de74c","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"kVuU2":[function() {},{}]},["8FW0f","etPzi","gNjPM","cWaQS","iw7Mm","73APt","iregX","hyiOl","4Zrfq","abVTo"], "abVTo", "parcelRequire3004")

//# sourceMappingURL=BarChartSplit.js.map
