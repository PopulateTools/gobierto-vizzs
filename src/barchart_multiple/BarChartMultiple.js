...
})({"6h2hr":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "15407e55dc8deacc";
...
},{}],"4aRuh":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('1P7EM') + "BarChartMultiple.css" + "?" + Date.now());
...
},{}],"9Wsg5":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('1P7EM') + "../barchart_stacked/BarChartStacked.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"dwuSg":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('1P7EM') + "../beeswarm/BeeSwarm.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"i4FXN":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('1P7EM') + "../commons/palette.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"2TP4B":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('1P7EM') + "../commons/tooltip.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"iy5fM":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('1P7EM') + "../gantt/Gantt.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"j8nvk":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('1P7EM') + "../treemap/TreeMap.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"ekCYD":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('1P7EM') + "../../examples/src/index.b8531977.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"8AewY":[function(require,module,exports) {
...
var _barChartMultipleCss = require("./BarChartMultiple.css");
class BarChartMultiple extends _baseDefault.default {
    ...
    build() {
        ...
        const dataNest = _d3Collection.nest().key((d)=>d[this.xAxisProp]
        ...
        const gColumn = this.g.selectAll('.column').data(dataNest).join('g').attr('class', 'column').attr('transform', (d)=>`translate(${this.scaleColumn(d[this.xAxisProp])},0)`
        );
        gColumn.append("text").attr('class', 'title').text((d)=>d[this.xAxisProp]
        ).call(this.wrap, this.width / [
            ...new Set(this.data.map((d)=>d[this.xAxisProp]
            ))
        ].length);
        gColumn.selectAll('.bar-chart-small-underlying').data((d)=>d.values
        ).join('rect').attr('class', 'bar-chart-small-underlying').attr('x', 0).attr('y', (d)=>this.scaleY(d[this.yAxisProp])
        ).attr('width', this.scaleColumn.bandwidth()).attr('height', this.scaleY.bandwidth()).attr('opacity', '.2').attr('fill', 'var(--gv-grey)');
        gColumn.selectAll('.bar-chart-small-overlying').data((d)=>d.values
        ).join('rect').attr('class', 'bar-chart-small-overlying').attr('x', 0).attr('y', (d)=>this.scaleY(d[this.yAxisProp])
        ).attr('width', (d)=>this.arrayOfScales[this.arrayOfXaxisProp.findIndex((element)=>element === d[this.xAxisProp]
            )](d[this.countProp])
        ).attr('height', this.scaleY.bandwidth()).attr("fill", (d)=>this.scaleColor(d[this.xAxisProp])
        );
        gColumn.selectAll(".label").data((d)=>d.values
        ).join('text').attr('class', 'label').text((d)=>d[this.countProp]
        ).each((d, i, element)=>{
            const xValue = this.arrayOfScales[this.arrayOfXaxisProp.findIndex((element)=>element === d[this.xAxisProp]
            )](d[this.countProp]);
            const xMax = _d3Selection.select(element[i])._groups[0][0].getBBox().width;
            if (xValue < xMax) _d3Selection.select(element[i]).attr('x', xValue + 10);
            else _d3Selection.select(element[i]).attr("fill", "#fff").attr('x', 0);
            _d3Selection.select(element[i]).attr('y', this.scaleY(d[this.yAxisProp]) + this.scaleY.bandwidth() / 2).attr('dy', '0.33em').attr('dx', 4);
        });
    }
    yAxis(g) {
        g.call(_d3Axis.axisLeft(this.scaleY));
        // remove baseline
    ...
    setScales() {
        ...
        this.scaleY = _d3Scale.scaleBand().domain(this.data.map((d)=>d[this.yAxisProp]
        ).reverse()).range([
            this.height,
            0
        ]).padding(0.4);
        this.scaleColumn = _d3Scale.scaleBand().domain([
            ...new Set(this.data.map((d)=>d[this.xAxisProp]
            ))
        ]).range([
            0,
    ...
    createArrayOfScales() {
        ...
        for (let scale of this.arrayOfXaxisProp){
            let elementScale = _d3Scale.scaleLinear().range([
                0,
                this.scaleColumn.bandwidth()
            ]).domain([
                0,
                _d3Array.max(this.data.filter((element)=>scale.includes(element[this.xAxisProp])
                ), (d)=>d[this.countProp]
                )
            ]).nice();
    ...
    calculateScaleXColumn(key) {
        return _d3Scale.scaleLinear().range([
            0,
            this.scaleColumn.bandwidth()
        ]).domain([
            0,
            _d3Array.max(this.data.filter((element)=>key.includes(element[this.xAxisProp])
            ), (d)=>d[this.countProp]
            )
        ]).nice();
    }
    ...
    setColorScale() {
        this.scaleColor = _d3Scale.scaleOrdinal().domain(Array.from(new Set(this.data.map((d)=>d[this.xAxisProp]
        )))).range(this.PALETTE);
    }
    setX(value) {
...
exports.default = BarChartMultiple;

},{"../commons/base":"i3PMv","d3-selection":"gn9gd","d3-array":"1yX2W","d3-collection":"lgnY5","d3-time":"1UOEe","d3-time-format":"4FtNS","d3-scale":"UQ8g3","d3-axis":"2g6gM","d3-transition":"4lorl","./BarChartMultiple.css":"iqWjn","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"i3PMv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _d3Selection = require("d3-selection");
var _d3TimeFormat = require("d3-time-format");
...
},{}],"izHCq":[function() {},{}],"3Cfo6":[function() {},{}],"lgnY5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./nest":"dBNxS","./set":"h9Dkt","./map":"gFXTu","./keys":"e6qKL","./values":"foy2e","./entries":"gwreO","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"dBNxS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _map = require("./map");
var _mapDefault = parcelHelpers.interopDefault(_map);
...
},{"./map":"gFXTu","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"gFXTu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"h9Dkt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _map = require("./map");
var _mapDefault = parcelHelpers.interopDefault(_map);
...
},{"./map":"gFXTu","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"e6qKL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"foy2e":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function(map) {
    var values = [];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"gwreO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = function(map) {
    var entries = [];
...
},{"./transition/index.js":"h2Srb","./transition/schedule.js":"de74c","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"iqWjn":[function() {},{}]},["6h2hr","4aRuh","9Wsg5","dwuSg","i4FXN","2TP4B","iy5fM","j8nvk","ekCYD","8AewY"], "8AewY", "parcelRequire3004")

//# sourceMappingURL=BarChartMultiple.js.map
