...
})({"6hIG4":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
},{}],"6fWGX":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('lC2tt') + "../barchart_split/BarChartSplit.css" + "?" + Date.now());
...
},{}],"268Dt":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('lC2tt') + "../barchart_stacked/BarChartStacked.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"cTNOF":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('lC2tt') + "../beeswarm/BeeSwarm.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"6A9Ur":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('lC2tt') + "../commons/palette.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"dn3qP":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('lC2tt') + "../commons/tooltip.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"bXuo1":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('lC2tt') + "Gantt.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"gHJzz":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('lC2tt') + "../treemap/TreeMap.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"lLLAu":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('lC2tt') + "../../examples/src/index.b8531977.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"5SiL5","./helpers/bundle-url":"ftuBb"}],"kZcl6":[function(require,module,exports) {
...
class Gantt extends _baseDefault.default {
    ...
    onPointerMove(event, d) {
        ...
        rects.filter((x)=>x[this.yAxisProp] !== d[this.yAxisProp]
        ).transition().duration(400).style("fill-opacity", 0.25);
        const [x1, y] = this.tooltipPosition(event, this.tooltipContainer.node(), 10);
        tooltip.style("top", `${y}px`).style("left", `${x1}px`).style("pointer-events", "auto").transition().duration(400).style("opacity", 1);
    }
    onPointerOut(_, d) {
        this.g.selectAll("rect.gantt-item").filter((x)=>x[this.yAxisProp] !== d[this.yAxisProp]
        ).transition().duration(400).style("fill-opacity", null);
...
},{"../commons/base":"i3PMv","d3-selection":"gn9gd","d3-scale":"UQ8g3","d3-axis":"2g6gM","d3-array":"1yX2W","d3-time-format":"4FtNS","d3-time":"1UOEe","d3-transition":"4lorl","./Gantt.css":"4dRuV","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"i3PMv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _d3Selection = require("d3-selection");
var _d3TimeFormat = require("d3-time-format");
...
},{"./transition/index.js":"h2Srb","./transition/schedule.js":"de74c","@parcel/transformer-js/src/esmodule-helpers.js":"3H7f3"}],"4dRuV":[function() {},{}]},["6hIG4","6fWGX","268Dt","cTNOF","6A9Ur","dn3qP","bXuo1","gHJzz","lLLAu","kZcl6"], "kZcl6", "parcelRequire3004")
