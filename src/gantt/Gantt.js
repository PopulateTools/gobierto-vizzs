...
})({"3XqES":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "d9a9b223f4a96710";
"use strict";
...
},{}],"gx39q":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('iGC5E') + "../beeswarm/BeeSwarm.css" + "?" + Date.now());
...
},{}],"bhcW2":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('iGC5E') + "Gantt.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"dypvJ","./helpers/bundle-url":"fa9F8"}],"asVH9":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('iGC5E') + "../treemap/TreeMap.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"dypvJ","./helpers/bundle-url":"fa9F8"}],"a94W9":[function(require,module,exports) {
require("./helpers/browser/css-loader")(require('./helpers/bundle-url').getBundleURL('iGC5E') + "../../examples/src/index.98542f67.css" + "?" + Date.now());

},{"./helpers/browser/css-loader":"dypvJ","./helpers/bundle-url":"fa9F8"}],"evGx1":[function(require,module,exports) {
...
class Gantt extends _baseDefault.default {
    ...
    setupElements() {
        ...
        this.legendContainer = _d3Selection.select(this.container).append("div").attr("class", "gv-legend");
    }
    build() {
        this.setScales();
        this.g.select(".axis-x").call(this.xAxis.bind(this));
        this.g.selectAll("rect.gantt-item").data(this.data, (d)=>d[this.idProp]
        ).join((enter)=>enter.append("rect").attr("class", "gantt-item").attr("x", (d)=>this.scaleX(d[this.fromProp])
    ...
    xAxis(g) {
        ...
        g.call(_d3Axis.axisTop(this.scaleX).tickFormat(hasMultipleYears ? _d3TimeFormat.timeFormat("%Y") : onlyOneYear ? _d3TimeFormat.timeFormat("%b") : _d3TimeFormat.timeFormat("%b-%Y")).tickSize(-this.height).ticks(hasMultipleYears ? _d3Time.timeYear : _d3Time.timeMonth).tickPadding(10));
        if (g.selectAll(".tick").size() > 8) g.selectAll(".tick:not(:nth-child(3n + 1)) text").remove();
        // remove baseline
    ...
    setScales() {
        ...
        this.scaleX = _d3Scale.scaleTime().domain([
            _d3Array.min(this.data, (d)=>d[this.fromProp]
            ),
            _d3Array.max(this.data, (d)=>d[this.toProp]
            )
        ]).rangeRound([
            0,
            this.width
...
},{"../commons/base":"9RF9X","d3-selection":"hgWtk","d3-scale":"hrwOn","d3-axis":"3HH3d","d3-array":"dclxS","d3-time-format":"ioDBG","d3-time":"lTNsW","./Gantt.css":"kZdUD","@parcel/transformer-js/src/esmodule-helpers.js":"4Rs9r","d3-transition":"cRYyR"}],"9RF9X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _d3Selection = require("d3-selection");
var _d3Transition = require("d3-transition");
...
},{"d3-selection":"hgWtk","d3-time-format":"ioDBG","9d720a8a2d0757ff":"ciOEs","@parcel/transformer-js/src/esmodule-helpers.js":"4Rs9r","d3-transition":"cRYyR","d3-ease":"elZFc"}],"hgWtk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./isoFormat.js":"eUcDj","./defaultLocale.js":"jvGVG","@parcel/transformer-js/src/esmodule-helpers.js":"4Rs9r"}],"ciOEs":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require('./helpers/bundle-url').getBundleURL('iGC5E') + "../../es-ES.2a26362b.js" + "?" + Date.now()).catch((err)=>{
...
},{"./transition/index.js":"18i1e","./transition/schedule.js":"dTpjR","@parcel/transformer-js/src/esmodule-helpers.js":"4Rs9r"}],"hrwOn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"d3-interpolate":"e7XwA","./continuous.js":"btLMJ","./init.js":"76hF6","./linear.js":"iCJmQ","./log.js":"8gycm","./sequential.js":"76Oio","./symlog.js":"etHgK","./pow.js":"kopvN","@parcel/transformer-js/src/esmodule-helpers.js":"4Rs9r"}],"3HH3d":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"4Rs9r"}],"kZdUD":[function() {},{}]},["3XqES","gx39q","bhcW2","asVH9","a94W9","evGx1"], "evGx1", "parcelRequire3004")
